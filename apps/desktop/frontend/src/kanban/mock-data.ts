...
export const mockKanbanTasks: KanbanTask[] = [
  ...
  { id: '5', title: '开发看板拖拽交互', participants: ['王五', '赵六'], status: 'in-progress', order: 0 },
  { id: '6', title: '实现 Markdown 实时预览', participants: ['李四'], status: 'in-progress', order: 1 },
  { id: '7', title: '单元测试覆盖率提升', participants: ['张三', '李四'], status: 'review', order: 0 },
  ...
  { id: '10', title: '需求分析与原型设计', participants: ['李四', '王五'], status: 'archive', order: 1 },
]
